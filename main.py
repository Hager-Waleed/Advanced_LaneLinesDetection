...
Original file is located at
    https://colab.research.google.com/drive/1lPVQqgxRjMmACct2lEE5aB5EoJnJB9Mo
"""
...
def preprocess_image(img, visualise=False):
    ...
    # 1. Distortion correction
    # mtx, dist = camera_Calibraton( "/content/drive/MyDrive/Image_processing_Project/camera_cal",9, 6, (720, 1280))
...
def pipeline(img,debug_mode ,visualise=False, diagnostics=False):
    global cache
...
process_frame = lambda frame: pipeline(frame,int(sys.argv[4]), diagnostics=1)
...
video1_output = sys.argv[2]
video1_input = VideoFileClip(sys.argv[1])
